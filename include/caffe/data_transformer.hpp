...
class DataTransformer {
 public:
  ...
  //void rescale_img(const cv::Mat& img, cv::Mat& scaled_img);
   ...
   */
  void Transform(const cv::Mat& cv_img_, Blob<Dtype>* transformed_blob);
#endif  // USE_OPENCV
 ...
 protected:
  ...
  void rescale_short_jitter(cv::Mat& imputImg, int short_min=240, int short_max=280);
